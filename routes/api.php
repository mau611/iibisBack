...
Route::middleware(['auth:sanctum'])->group(function () {
    Route::get('/user', function (Request $request) {
        return $request->user()->load('investigador');
    });

    Route::controller(OperacionController::class)->group(function () {
        Route::get('/operaciones/{gestion}', 'index');
        Route::get('/operaciones_investigador/{invId}/{gestion}', 'operacionesInvestigador');
    ...
    Route::controller(SispoasController::class)->group(function () {
        ...
        Route::get('/sispoas_inv/{invId}/{gestion}', 'getProyectosByInvestigadorAndGestion');
    ...
    Route::controller(DocumentoSeguimientoController::class)->group(function () {
        ...
        Route::post('/documento_seguimiento_gestion/{seguimientoId}', 'storeDocumentoSeguimientoGestion');
    });
